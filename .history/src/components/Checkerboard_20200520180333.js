                        ...
                        <div className="boardRow">{number.map((a) =>
                            <div>{a.cell == 0 ? 
                                <div className="blackcels">
                                    {a.id === this.state.cellMove.idleft ? <div className="movecell"></div>: <div></div> }
                                    {a.id === this.state.cellMove.idrighr ? <div className="movecell"></div>: <div></div> }
