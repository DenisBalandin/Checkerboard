    ...
    //    console.log(JSON.parse(localStorage.getItem('saveGame')));
     ///   if(this.state.newGame === 0){
      ...
      //  }else{
            ...
            JSON.parse(localStorage.getItem('startArray')).map((a)=>{
                console.log(a);

                // console.log(a.id);
            //     const itemsst = finalArray;
            //     const item = itemsst.find(item => item.id === a.id);
            //     const itemIndex = itemsst.indexOf(item);
            // //  console.log(item);
    
            //     if(a.piece !== item.piece){
            //     //  console.log(item.piece);
            //         itemsst[itemIndex]['piece'] = item.piece;
            //         this.setState({
            //             startArray: itemsst,
            //         }); 
            //     }
