...
class Checkeredboard extends Component{
    ...
    componentDidMount = () =>{
        ...
        for(let i = 0; i < n; i++){
            ...
            if(i % 2 ==0 ){
                if(i < 16){
                    finalArray.push({id:id,cell:1,piece:2})
                }else if( i >= n - 16){
                    finalArray.push({id:id,cell:1,piece:3})
                }else{
                    finalArray.push({id:id,cell:1,piece:0})
                }
            }else{
                if(i < 16){
                    finalArray.push({id:id,cell:0,piece:2})
                }else if( i >= n - 16){
                    finalArray.push({id:id,cell:0,piece:3})
                }else{
                    finalArray.push({id:id,cell:0,piece:0})
                }
            }
